...
<img src="https://img.shields.io/badge/Surrey%2C%20BC-1a1b27?style=for-the-badge&logo=googlemaps&logoColor=7aa2f7" alt="Surrey, BC" />
...
- **Master of Professional Studies in Data Analytics (AI/ML concentration):** Northeastern University, Vancouver, Class of 2026
- **B.Tech in Information Technology:** Uka Tarsadia University, India, graduated with Distinction
- Previously **Data & Operations Analyst @ Northeastern University:** audited MySQL cost-calculation logic to correct ~$120K CAD of misapplied tax, and cut Power BI refresh time 13%
...
- Earlier **Software Developer @ Dots N Key** (India, 2022-2024): React/Node.js/MySQL retail POS used across 150+ stores, including its migration from MySQL to AWS RDS
- Currently building a **Credit Risk Analytics Pipeline** on Databricks: bronze/silver/gold Delta Lake medallion over 2.26M Lending Club loans
- Also building a **Multi-City Weather Data Warehouse:** idempotent Python ELT loading 105K hourly readings from 12 cities into a PostgreSQL star schema
- **Open to Software / Data / AI roles:** Metro Vancouver, BC
